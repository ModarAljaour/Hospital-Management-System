                        ...
                        <div class="inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <div class="content">
                                ...
                                <div class="count-outer count-box">
                                    +<span class="count-text" data-speed="2500" data-stop="{{App\Models\Patient::count()}}">0</span>
                                </div>
                        ...
                        <div class="inner wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="content">
                                ...
                                <div class="count-outer count-box alternate">
                                    +<span class="count-text" data-speed="4000" data-stop="{{App\Models\Doctor::count()}}">0</span>
                                </div>
                    ...
                    <div class="column counter-column col-lg-3 col-md-6 col-sm-12">
                        <div class="inner wow fadeInLeft" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="content">
                                <div class="icon flaticon-logout"></div>
                                <div class="count-outer count-box">
                                    +<span class="count-text" >{{App\Models\Invoice::where('invoice_type' , 1)->count()}}</span>
                                </div>
                                <h4 class="counter-title">Single Invoices</h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="column counter-column col-lg-3 col-md-6 col-sm-12">
                        <div class="inner wow fadeInLeft" data-wow-delay="900ms" data-wow-duration="1500ms">
                            <div class="content">
                                <div class="icon flaticon-logout"></div>
                                <div class="count-outer count-box">
                                    +<span class="count-text" >{{App\Models\Service::count()}}</span>
                                </div>
            ...
            <div class="inner-container">
                <div class="row clearfix">
                    ...
                    <div class="doctor-block col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <h3>Working Hours</h3>
                            @foreach(App\Models\TimeTranslation::all() as $time)
                            <ul class="doctor-time-list">
                                <li>{{$time->name }}<span>8:00am–7:00pm</span></li>
