                        ...
                        <a href="#" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown"
                            ...
                            @if (App::getLocale() == 'ar')
                                <span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img
                                        src="{{ URL::asset('Dashboard/img/flags/syria.png') }}" alt="img"></span>
                                <strong
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown nav-item main-header-notification">
                    ...
                    <div class="dropdown-menu dropdown-notifications">
                        <div class="menu-header-content bg-primary text-right">
                            ...
                            <p data-count="{{ App\Models\Notification::CountNotification(auth()->user()->id)->count() }}" class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 notif-count">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    ...
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user"><img alt=""
                                        src="{{ URL::asset('Dashboard/img/svgicons/chrome.svg') }}" class=""></div>
                                @if (auth('admin')->check())
                                    <div class="mr-3 my-auto">
                                        <h6>{{ auth('admin')->user()->name }}</h6><span>
                        ...
                        <a class="dropdown-item" href=""><i class="bx bx-user-circle"></i>change password</a>
...
<script>
    ...
    // this  lines for public channel without Echo laravel - just pusher ::

   /* var pusher = new Pusher('09f69fb3639f8445d737', {
        cluster: 'mt1'
    });
    ...
    */
    ...
    // This line for pusher with laravel-echo (for private channel) ::
    ...
    // الاستماع لقناة الإداريين
    Echo.private('admin-notifications').listen('.create-invoice', (data) => {
        var newNotificationHtml = `
       <h4 class="notification-label mb-1">` + data.message + data.patient + `</h4>
       <div class="notification-subtext">` + data.created_at + `</div>`;
        new_message.show();
...
{{--        // alert('patientID: ' + data.patient_id);--}}
{{--        --}}
{{--    });--}}
{{--</script>--}}
