...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="main-dashboard-header-right">
            ...
            <div>
                <label class="tx-13">{{ trans('Dashboard_Ray/ray_employee.count_row') }} </label>
                <h5>{{ App\Models\Ray::count() }}</h5>
            </div>
        </div>
    </div>
    ...
    <div class="row row-sm">
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-danger-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-12 text-white">اجمالي عدد الكشوفات تحت الاجراء</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-success-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-12 text-white">اجمالي عدد الكشوفات المكتملة</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
        ...
        <div class="col-md-12 col-lg-12 col-xl-12">
            <div class="card card-table-two">
                <div class="d-flex justify-content-between">
                    <h2 class="card-title mb-1">اخر 10 الكشوفات علي النظام</h2>
                </div><br>
