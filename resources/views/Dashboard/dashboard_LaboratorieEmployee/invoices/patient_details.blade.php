    ...
    <div class="demo-gallery">
        <ul id="lightgallery" class="list-unstyled row row-sm pr-0">
            ...
            @foreach($laboratorie->images as $image)
                ...
                <li class="col-sm-6 col-lg-4" data-responsive="{{URL::asset('storage/Laboratories/'.$image->filename)}}" data-src="{{URL::asset('Dashboard/img/Laboratories/'.$image->filename)}}">
                    <a href="#">
                        <img width="50px" height="350px" class="img-responsive" src="{{URL::asset('storage/Laboratories/'.$image->filename)}}" alt="NoImg">
                    </a>
                </li>
            @endforeach
        </ul>
