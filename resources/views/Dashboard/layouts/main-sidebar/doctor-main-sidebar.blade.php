        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">الكــشوفـات</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('invoices.index') }}">{{ trans('الكشوفات') }} </a></li>
                    <li><a class="slide-item" href="{{ route('reviewinvoice') }}">قائمة المراجعات</a></li>
                    <li><a class="slide-item" href="{{ route('completedinvoice') }}">قائمة الكشوفات
                            المكتملة</a></li>
