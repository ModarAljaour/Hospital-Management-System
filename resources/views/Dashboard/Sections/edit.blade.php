        ...
        <div class="modal-content">
            ...
            <form action="{{ route('section.update', 'test') }}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="id" value="{{ $section->id }}" class="form-control"><br>

                    <label for="description">{{ trans('sections_trans.description') }}</label>
                    <input type="text" name="description" id="price" value="{{ $section->description }}"
                        class="form-control"><br>
