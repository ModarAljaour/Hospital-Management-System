...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="slide">
                <a class="side-menu__item" href="{{ route('dashboard.laboratory_employee') }}"><svg
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">كشوفات المخبر</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('laboratory.index') }}"> التحليلات </a></li>
                    <li><a class="slide-item" href="{{ route('completed_analysis') }}">قائمة التحليلات
                            المكتملة</a></li>
