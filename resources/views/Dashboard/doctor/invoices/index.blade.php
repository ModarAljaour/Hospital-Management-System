...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ trans('Doctors.diagnosis') }}</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/

                    {{ trans('Doctors.invoices') }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                            ...
                            <tbody>
                                @foreach ($invoices as $invoice)
                                    <tr>
                                        ...
                                        <td><a
                                                href="{{ route('patient-details', $invoice->patient_id) }}">{{ $invoice->Patient->name }}</a>
                                        </td>
