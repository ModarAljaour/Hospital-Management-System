        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label"> عملبات المريض</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('invoice-patient') }}"> قائمة الفواتير </a></li>
                    <li><a class="slide-item" href="{{ route('laboratory-patient') }}">المختبر </a></li>
                    <li><a class="slide-item" href="{{ route('ray-patient') }}">الاشعة </a></li>
