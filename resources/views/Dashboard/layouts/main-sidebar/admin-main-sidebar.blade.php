<div class="main-sidemenu">
    ...
    <ul class="side-menu">
        <li class="side-item side-item-category">{{ trans('main-sidebar_trans.sections') }}</li><br>
        <li class="slide">
            <a class="side-menu__item" href="{{ route('dashboard.admin') }}"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                </svg><span class="side-menu__label">{{ trans('main-sidebar_trans.index') }} </span><span
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item"
                        href="{{ route('section.index') }}">{{ trans('main-sidebar_trans.view_all') }}</a>
                </li>
            </ul>
        </li>
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item"
                        href="{{ route('doctor.index') }}">{{ trans('main-sidebar_trans.view_all') }}</a></li>
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                ...
                </svg><span class="side-menu__label">{{ trans('patient.patient') }}</span><i
                    class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{ route('patient.create') }}">{{ trans('patient.add_patient') }}</a>
                </li>
                <li><a class="slide-item" href="{{ route('patient.index') }}">عرض المرضى</a></li>
            </ul>
        </li>
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                ...
                <li><a class="slide-item"
                        href="{{ route('add_group_service') }}">{{ trans('main-sidebar_trans.group_services') }}</a>
                </li>
                <li><a class="slide-item"
                ...
                <li><a class="slide-item" href="">{{ trans('main-sidebar_trans.Ambulance_calls') }}</a>
                </li>
            </ul>
        </li>
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                ...
                </svg><span class="side-menu__label">{{ trans('invoices.invoices') }}</span><i
                    class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item"
                        href="{{ route('single-invoices') }}">{{ trans('invoices.single_invoices') }}</a></li>
                <li><a class="slide-item" href="{{ route('group-invoices') }}">فواتير مجمعة</a></li>
            </ul>
        </li>
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                ...
                </svg><span class="side-menu__label">حسابات</span><i class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                ...
                </svg><span class="side-menu__label">{{ trans('main-sidebar_trans.Ray') }}</span><i
                    class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item"
                        href="{{ route('ray_employee.index') }}">{{ trans('main-sidebar_trans.RayEmployee') }}
                    </a>
                </li>
                <li><a class="slide-item"
                        href="{{ route('ray_employee.store') }}">{{ trans('main-sidebar_trans.diagnoses') }}
                    </a>
                </li>
            </ul>
        </li>
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                ...
                </svg><span class="side-menu__label">المخـــتبـر</span><i class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{route('laboratory-employee.index') }}">عرض </a></li>
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{ route('appointment-index') }}">قائمة المواعيد </a></li>
                <li><a class="slide-item" href="{{ route('appointment-certain' )  }}">قائمة المواعيد المؤكدة </a></li>
                <li><a class="slide-item" href="{{ route('appointment-done' )  }} ">قائمة المواعيد المنتهية </a></li>
            </ul>
        </li>
